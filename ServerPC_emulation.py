...
# Программа для эмуляции сервера
# Подключается к компьютеру УПК, отправляет ему JSON с описанием оборудования (считывается из файла)
# Получает данные и выводит их на экран
...
def run_server(loop=None):
    ...
    while True:
        loop.run_until_complete(hello('ws://217.74.248.42:7681'))
...
if __name__ == "__main__":
    ...
    # описание оборудования считывается из файла
